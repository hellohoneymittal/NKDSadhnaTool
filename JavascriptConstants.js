...
const API_CONSTANT = {
  ...
  GET_BG_BOOK_MCQ_RESULT: "GET_BG_BOOK_MCQ_RESULT",
...
function isKartikDataVisible() {
  const startDate = moment("2025-10-07", "YYYY-MM-DD");
  const endDate = moment("2025-11-05", "YYYY-MM-DD");
...
const GG_LAT = 28.657501589771897;
const GG_LONG = 77.43753484576277;
